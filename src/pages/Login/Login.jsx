...
export default function Login({handleIsOpen}) {
    return (
        <div className="bg-[#0000007d] w-full min-h-screen fixed inset-0 z-30 flex items-center justify-center font-karla">
            ...
            >
                <button onClick={handleIsOpen}><RxCross1 className="absolute right-5 top-5 hover:opacity-85" /></button>
                ...
                <p className="leading-4">
                    This is a hobby project for development purpose only. No
                    well suited backend has been used here. Please use{" "}
                    <b>atuny0</b> as username & <b>9uQFF1Lh</b> as password. You
                    can find these credentials in the placeholder also.{" "}
